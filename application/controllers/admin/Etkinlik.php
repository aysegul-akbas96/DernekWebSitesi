...
class Etkinlik extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('admin/etkinlik_listele',$data);
		...
		public function duzenle($id)
	{
		...
		$query=$this->db->query("SELECT * FROM etkinlik WHERE id=$id");
				...
				$this->load->view('admin/etkinlik_duzenle',$data);
}
   ...
   $query=$this->db->query("SELECT * FROM etkinlik WHERE id=$id");
        ...
        else
            {
			   ...
			   $this->Database_Model->update_data("etkinlik",$data,$id);
              	 ...
              	 $data=array(
                        ...
                        'etkinlik_aciklama'=>$this->input->post('etkinlik_aciklama'),
			   ...
			   redirect(base_url()."admin/etkinlik");
	 ...
	 public function ekle(){
		...
		$data["menu"]="Admin Paneli ";
	   	 $query=$this->db->query("SELECT * FROM etkinlik");
				$data["veriler"]=$query->result();
				$this->load->view('admin/etkinlik_ekle',$data);
			    ...
			    $upload_data=$this->upload->data();
                      ...
                      $data=array(
                       ...
                       'resim'=>$upload_data["file_name"],                    
                       	...
                       	$this->db->insert("etkinlik",$data);
			   $this->session->set_flashdata("mesaj","Yeni Etkinlik Eklendi !"); 
			   redirect(base_url()."admin/etkinlik");
			}
		}

      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 ftco-animate">
            <p>
              <img style="width: 600px; height: 400px;" src="<?=base_url()?>uploads/<?=$verim[0]->resim?>" alt="" class="img-fluid">
            </p>
            <h2 class="mb-3"><?=$verim[0]->haber_adi?></h2>
            <span><i class="icon-calendar mr-2"></i> <?=$verim[0]->haber_tarih?></span>
            <br><br>
            
            <p><?=$verim[0]->haber_aciklama?></p>

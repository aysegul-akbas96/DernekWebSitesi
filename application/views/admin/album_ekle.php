  ...
  <?php }?>
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-lg-12">
                                          <div><br>
                                            ...
                                            <form method="post"  enctype="multipart/form-data" autocomplete="off" action="<?=base_url()?>admin/album/ekle_kaydet" role="form">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="album_adi"  class="form-control" id="email1" placeholder="">
                                        </div>
                                    </div>

             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Dernek Yönetimi</h4>
                            ...
                            <div class="card-body">
                               <form class="form-horizontal" method="post" autocomplete="off"  enctype="multipart/form-data"  action="<?=base_url()?>admin/dernek/ekle_kaydet" role="form">
                                ...
                                <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="email-input" name="baslik"  placeholder="" class="form-control"></div>
                                    </div>
                                    ...
                                    <div class="col-sm-9">
                                            <textarea name="aciklama" class="ckeditor" id=""></textarea>

...
<div class="col-lg-6">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Dernek Yönetimi</strong>
                            </div>
                              </div>
            </div>
          </div>
...
<div class="row mb-3">
                                    ...
                                    <div class="col-lg-3 ">
                                         <a href="<?=base_url()?>admin/dernek/ekle?>" class="btn btn-success btn-success"><i class=" ti-new-window"></i>Yeni bölüm ekle</a> 
                                    </div>
                                </div>

...
?> 
             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Haber Yönetimi</h4>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                              <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?=base_url()?>admin/haber/guncelle/<?=$veri[0]->id?>" autocomplete="off" role="form">

                                <div class="row form-group">
                                        <div class="col col-md-3"><label for="email-input" class=" form-control-label">Başlık</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="email-input" name="haber_adi" value="<?=$veri[0]->haber_adi?>" placeholder="" class="form-control"></div>
                                    </div>
 ...
 <div class="form-group row">
                                ...
                                Haber Tarih</label></div>
                                    <div class="col-12 col-md-9"><input type="datetime" id="email-input" name="haber_tarih" value="<?=$veri[0]->haber_tarih?>" placeholder="" class="form-control"></div>
                                </div>
                                    ...
                                    <div class="col-sm-9">
                                            <textarea name="haber_aciklama" class="ckeditor" id=""><?=$veri[0]->haber_aciklama?></textarea>

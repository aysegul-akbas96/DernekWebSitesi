        ...
        <div class="row mb-5">
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4 ml-md-5">
              <h2 class="ftco-heading-2">Telefon</h2>
              <ul class="list-unstyled">
                <li><span class=""></span><?=$veri[0]->telefon?></li>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4 ml-md-5">
              ...
              <ul class="list-unstyled">
                <li><span class=""></span><?=$veri[0]->email?></li>
          ...
          <div class="col-md">
             <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2">Website</h2>
              <div class="opening-hours">
              	
              	<p class="pl-3">
              		<span class="mb-3"><?=$veri[0]->website?></span>
